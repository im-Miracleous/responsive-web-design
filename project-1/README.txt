...
<label for="self-verification">
              <input class="inline" id="self-verification" name="self-verification" type="checkbox" value="" required /> I ensure that all that I've filled in this form are true and met the <a href="https://www.freecodecamp.org/news/terms-of-service/">terms and regulations</a>. If there are any mistakes, I understand of the consequences of being banned from the giveaway.
            </label>